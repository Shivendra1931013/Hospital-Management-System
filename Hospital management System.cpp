...
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|                                                 -by Shivendra Pratap Singh            |@@\n";
cout<<"\t\t\t\t\t@@|_______________________________________________________________________________________|@@\n";
cout<<"\t\t\t\t\t@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n\n\n\n\t\t\t\t\t";
system("pause");
system("cls");
...
cout<<"\t\t\t\t\t\t|             6  >> Full History of Doctors                       |\n";
cout<<"\t\t\t\t\t\t|             7  >> Add New Nurse                                 |\n";
cout<<"\t\t\t\t\t\t|             8  >> Full History of Nurse                         |\n";
cout<<"\t\t\t\t\t\t|             9  >> Information about medicine                    |\n";
cout<<"\t\t\t\t\t\t|             10 >> Add Appointment of Patient                    |\n";
cout<<"\t\t\t\t\t\t|             11 >> Appointment Details                           |\n";
...
//Adding the record of the new doctor..................option 3
if(i==5)
{
  time_t rawtime;
  struct tm * timeinfo;
  ...
  pat_file.open(fname);
		...
		else
		{
            ...
            cout<<"\nSex : ";pat_file<<"Sex : ";gets(ak.sex);pat_file<<ak.sex<<"\n";
            //cout<<"\nBlood Group : ";pat_file<<"Blood Group : ";gets(ak.blood_gp);pat_file<<ak.blood_gp<<"\n";
            cout<<"\nspecialisation : ";pat_file<<"specialisation : ";gets(ak.specialisation);pat_file<<ak.specialisation<<"\n";
            cout<<"\ndoctor ID : ";pat_file<<"doctor ID : ";gets(ak.id);pat_file<<ak.id<<"\n";
            cout<<"\n********************************************************************\n";pat_file<<"\n********************************************************************\n\n";
            cout<<"\nInformation Saved Successfully\n";
            }
  system("pause");
...
//For displaying the full of doctors in that hospital............option 3
if(i==6)
{
    fstream pat_file;
...
//Adding the record of the new nurse..................option 3
if(i==7)
{
  time_t rawtime;
  struct tm * timeinfo;
  ...
  pat_file.open(fname);
		...
		else
		{
            ...
            cout<<"\nSex : ";pat_file<<"Sex : ";gets(ak.sex);pat_file<<ak.sex<<"\n";
            //cout<<"\nBlood Group : ";pat_file<<"Blood Group : ";gets(ak.blood_gp);pat_file<<ak.blood_gp<<"\n";
            cout<<"\ntype of work : ";pat_file<<"type of work : ";gets(ak.type_of_work);pat_file<<ak.type_of_work<<"\n";
            cout<<"\nnurse ID : ";pat_file<<"nurse ID : ";gets(ak.id);pat_file<<ak.id<<"\n";
            cout<<"\n********************************************************************\n";pat_file<<"\n********************************************************************\n\n";
            cout<<"\nInformation Saved Successfully\n";
            }
  system("pause");
...
//For displaying the full history of nurses in that hospital............option 3
if(i==8)
{
    fstream pat_file;
    cout<<"\n\nEnter the nurse's file name to be opened : ";
    cin.ignore();
    gets(fname);
    system("cls");
	pat_file.open(fname, ios::in);
...
//Adding the Appointment of the new patient..................option 3
if(i==10)
{
  time_t rawtime;
  struct tm * timeinfo;
  ...
  pat_file.open(fname);
		...
		else
		{
            ...
            cout<<"\nAge : ";pat_file<<"Age : ";gets(ak.age);pat_file<<ak.age<<"\n";
            cout<<"\nSex : ";pat_file<<"Sex : ";gets(ak.sex);pat_file<<ak.sex<<"\n";
            cout<<"\nday : ";pat_file<<"day : ";gets(ak.day);pat_file<<ak.day<<"\n";
            cout<<"\nmonth : ";pat_file<<"month : ";gets(ak.month);pat_file<<ak.month<<"\n";
            cout<<"\ndoctor_appointment : ";pat_file<<"doctor_appointment : ";gets(ak.doctor_appointment);pat_file<<ak.doctor_appointment<<"\n";
            cout<<"\n********************************************************************\n";pat_file<<"\n********************************************************************\n\n";
            cout<<"\nInformation Saved Successfully\n";
            }
  system("pause");
...
//For appointment details  of patient in that hospital............option 3
if(i==11)
{
    fstream pat_file;
    cout<<"\n\nEnter the patient's file name to be opened : ";
	...
	pat_file.open(fname, ios::in);
		...
		{
		    cout<<"\n\n\n\n\t\t\t\t........................................ Full appointment details of "<<fname<<" ........................................\n\n\n\n";
		    string info;
			while(pat_file.good())
			{
			getline(pat_file,info);
